...
@section('content')
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                &quot;Our&quot; in this Agreement) refers to Ronzier.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Ronzier, accessible from <a href="http://www.ronzier.alwaysdata.net"
                    rel="external nofollow noopener" target="_blank">http://www.ronzier.alwaysdata.net</a></p>
        </li>
        <li>
    ...
    <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal
        ...
        browser. You can learn more about cookies here: <a href="https://www.termsfeed.com/privacy-policy-generator/#faq-8"
    ...
    <ul>
        <li>
            <p>By email: ronzier@alwaysdata.net</p>
        </li>
        <li>
            <p>By visiting this page on our website: <a href="http://www.ronzier.alwaysdata.net/privacy-policy"
                    rel="external nofollow noopener" target="_blank">http://www.ronzier.alwaysdata.net/privacy-policy</a>
            </p>
        </li>
    </ul>
@endsection
